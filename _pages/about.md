...
My recent work has focused on developing online resources to better understand extracellular RNAs (e.g., [the exRNA Atlas](https://exrna-atlas.org/)), but I'm excited to move into statistical genomics as a graduate student. Right now, I'm rotating in [Dr. Josh Akey's lab](https://akeylab.princeton.edu/).
